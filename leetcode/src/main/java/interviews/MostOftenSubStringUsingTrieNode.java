 ...
 */
public class MostOftenSubStringUsingTrieNode {
  public static void main(String[] args){
    MostOftenSubStringUsingTrieNode most = new MostOftenSubStringUsingTrieNode();
    System.out.print(most.getHighestFrequencyOfSubstring(5, 2,4,26,"abcde"));
  }
  TrieNode root;
